...
const Counter = ({
    ...
    const sizeClasses = {
        ...
        md: 'w-5 sm:w-[32px] aspect-square',
        lg: 'w-5 xs:w-[32px] sm:w-[50px] aspect-square',
    };

    const buttonClasses = cn(
        `rounded flex items-center justify-center border border-zinc-100 dark:border-border text-base text-theme-secondary-light ${sizeClasses[size]}`,
        classNames?.button,
    );
