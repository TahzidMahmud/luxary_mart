...
@section('content')
    ...
    <div class="card theme-table">
        <div
            ...
            <x-backend.inputs.link href="{{ route('seller.stockAdjustments.create') }}"> <span class="text-xl">
                        ...
                        <td>
                            <div class="option-dropdown w-full" tabindex="0">
                                ...
                                <div class="option-dropdown__options">
                                    <ul>
                                        <li>
                                            <a href="{{ route('seller.stockAdjustments.show', ['adjustment' => $stockAdjustment->id]) }}"
