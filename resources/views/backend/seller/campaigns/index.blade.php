...
@section('content')
    ...
    <div class="dashboard-nav pt-6 flex items-center justify-between mb-9">
        ...
        <div class="max-sm:hidden flex items-center gap-2">
            <a href="{{ route('seller.campaigns.index') }}" class="font-bold ">{{ translate('Campaigns') }}</a>
    ...
    <div class="card theme-table">
        <div
            ...
            <x-backend.inputs.link href="{{ route('seller.campaigns.create') }}"> <span class="text-xl">
                        ...
                        <td>
                            <div class="option-dropdown" tabindex="0">
                                ...
                                <div class="option-dropdown__options">
                                    <ul>
                                        <li>
                                            <a href="{{ route('seller.campaigns.edit', ['campaign' => $campaign->id, 'lang_key' => config('app.default_language')]) }}&translate"
                                                class="option-dropdown__option">
                                                {{ translate('Edit') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('seller.campaigns.show', ['campaign' => $campaign->id, 'lang_key' => config('app.default_language')]) }}&translate"
                                                class="option-dropdown__option">
                                                {{ translate('Products') }}
                                            </a>
                                        </li>
                                        <li>
                                            <x-backend.inputs.delete-link
                                                href="{{ route('seller.campaigns.destroy', $campaign->id) }}" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
