...
@section('content')
    ...
    <div class="dashboard-nav pt-6 flex items-center justify-between mb-9">
        ...
        <div class="max-sm:hidden flex items-center gap-2">
            <a href="{{ route('seller.coupons.index') }}" class="font-bold ">{{ translate('Coupons') }}</a>
    ...
    <div class="card theme-table">
        <div
            ...
            <x-backend.inputs.link href="{{ route('seller.coupons.create') }}"> <span class="text-xl">
                        ...
                        <td>
                            <div class="option-dropdown" tabindex="0">
                                ...
                                <div class="option-dropdown__options">
                                    <ul>
                                        <li>
                                            <a href="{{ route('seller.coupons.edit', ['coupon' => $coupon->id, 'lang_key' => config('app.default_language')]) }}&translate"
                                        ...
                                        <li>
                                            <x-backend.inputs.delete-link
                                                href="{{ route('seller.coupons.destroy', $coupon->id) }}" />
                                        </li>
                                    </ul>
                                </div>
                            </div>
