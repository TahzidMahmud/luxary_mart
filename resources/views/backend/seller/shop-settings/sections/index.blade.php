                                        ...
                                        <td>
                                            <div class="option-dropdown" tabindex="0">
                                                ...
                                                <div class="option-dropdown__options">
                                                    <ul>
                                                        <li>
                                                            <a href="{{ route('seller.shop-sections.edit', ['section' => $section->id, 'lang_key' => config('app.default_language')]) }}&translate"
                                                        ...
                                                        <li>
                                                            <x-backend.inputs.delete-link
                                                                href="{{ route('seller.shop-sections.destroy', $section->id) }}" />
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
