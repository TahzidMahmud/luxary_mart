    ...
    <div class="card theme-table">
        <div
            ...
            @can('create_stock_transfer')
                <x-backend.inputs.link href="{{ route('admin.stockTransfers.create') }}"> <span class="text-xl">
                        ...
                        <td>
                            <div class="option-dropdown w-full" tabindex="0">
                                ...
                                <div class="option-dropdown__options">
                                    <ul>
                                        @can('show_stock_transfer_details')
                                            <li>
                                                <a href="{{ route('admin.stockTransfers.show', ['transfer' => $stockTransfer->id]) }}"
