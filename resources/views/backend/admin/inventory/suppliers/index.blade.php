    ...
    <div class="card theme-table">
        <div
            ...
            @can('create_suppliers')
                <x-backend.inputs.link href="{{ route('admin.suppliers.create') }}"> <span class="text-xl">
                            ...
                            <div class="option-dropdown" tabindex="0">
                                ...
                                <div class="option-dropdown__options">
                                    <ul>
                                        @can('edit_suppliers')
                                            <li>
                                                <a href="{{ route('admin.suppliers.edit', ['supplier' => $supplier->id, 'lang_key' => config('app.default_language')]) }}&translate"
