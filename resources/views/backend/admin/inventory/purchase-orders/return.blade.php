                    ...
                    <tr>
                        ...
                        <td class="text-warning-500">
                            <a class="text-blue-500"
                                href="{{ route('admin.purchase-orders.index') }}?search=PO-{{ $returnOrder->purchaseOrder->reference_code }}">#PO-{{ $returnOrder->purchaseOrder->reference_code }}</a>
                        </td>
                        ...
                        <td>
                            <div class="option-dropdown w-full" tabindex="0">
                                ...
                                <div class="option-dropdown__options">
                                    <ul>
                                        <li>
                                            <a href="{{ route('admin.purchase-return.create', ['id' => $returnOrder->purchase_order_id]) }}"
