                    ...
                    <table class="min-w-full">
                        <thead class="bg-theme-primary/10 border-b border-border">
                            <tr class="text-left">
                                ...
                                <th class="p-4 {{ !Route::is('admin.stockAdjustments.show') ? 'w-[200px]' : 'w-[280px]' }}"
                                    data-breakpoints="xs sm">
                                    {{ translate('Product') }}
                                </th>
                                @if (!Route::is('admin.stockAdjustments.show'))
                                ...
                                <th class="p-4 {{ !Route::is('admin.stockAdjustments.show') ? '' : 'text-end' }}"
                                    data-breakpoints="xs sm">
                                    {{ translate('Qty') }}
                                </th>
