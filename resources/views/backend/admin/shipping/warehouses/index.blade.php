                    ...
                    @foreach ($warehouses as $key => $warehouse)
                        <tr>
                            ...
                            <td>
                                @can('edit_warehouses')
                                    <x-backend.inputs.checkbox toggler="true"
                                        data-route="{{ route('admin.warehouses.status') }}" name="isActiveCheckbox"
                            ...
                            <td>
                                ...
                                @can('edit_warehouses')
                                    <x-backend.inputs.checkbox toggler="true"
                                        data-route="{{ route('admin.warehouses.default') }}" name="isDefaultCheckbox"
                                ...
                                <div class="option-dropdown" tabindex="0">
                                    ...
                                    <div class="option-dropdown__options">
                                        <ul>
                                            @can('edit_warehouses')
                                                <li>
                                                    <a href="{{ route('admin.warehouses.edit', ['warehouse' => $warehouse->id, 'lang_key' => config('app.default_language')]) }}&translate"
                                            ...
                                            @can('delete_warehouses')
                                                <li>
                                                    <x-backend.inputs.delete-link
                                                        href="{{ route('admin.warehouses.destroy', $warehouse->id) }}" />
                                                </li>
                                            @endcan
                                        </ul>
                                    </div>
