        ...
        <div class="flex items-center grow gap-14">
            <div class="flex items-center gap-7">
                ...
                <a href="{{ route('admin.dashboard') }}">
                    <img src="{{ uploadedAsset(getSetting('websiteHeaderLogo')) }}" class="max-h-[60px]" alt="EpikCart"
                ...
                <div class="option-dropdown__options">
                    <ul>
                        ...
                        @can('create_stock_adjustment')
                            <li>
                                <a href="{{ route('admin.stockAdjustments.create') }}"
                        ...
                        @can('create_stock_transfer')
                            <li>
                                <a href="{{ route('admin.stockTransfers.create') }}"
                                        ...
                                        <a href="{{ getNotificationLink($notification) }}"
                                            ...
                                            <div>
                                                ...
                                                <div class="flex items-center text-muted">
                                                    <span
                                                        class="truncate">{{ $notification->created_at->diffForHumans() }}</span>
                                                    <span
                                                        class="ml-[9px] mr-[7px] h-[5px] w-[5px] rounded-full bg-theme-secondary"></span>
                                                    <span class="capitalize truncate">{{ $notification->type }}</span>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
